...
const token = "7246365562:AAEkqCSm6RNcJc4z0BTzpF7_c7eScgH4ty4";
admin_account = [6194563716];
USER_FILE = "users.txt";
LOG_FILE = "log.txt";
  ...
  try {
    if (!premiumMembers.includes(chatId) && !admin_account.includes(chatId)) {
      const message = await bot.sendMessage(
        chatId,
        `Dear ${msg.chat.first_name},\nYou're Not a Premium Member,\nBuy Premium from: @Mahend_OpMirza`
      );
      ...
      if (target && port) {
        ...
        const message = `Dear ${msg.chat.first_name},\nPlease Type Command Like:\n/bgmi_private Target Port.\n<b>Note: No Need To Specify Time Because Best Time Is Already In System By @Mahend_OpMirza.</b>\nThanks For Your Support.`;
        await bot.sendMessage(chatId, message, {
          parse_mode: "HTML",
          reply_to_message_id: msg.message_id,
        });
